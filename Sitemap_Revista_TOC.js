/**
 * Sitemap Blogger Revista TOC Script by CCB
 * URL: https://cambio-cambie.blogspot.com
 */
var tocConfig = {
    url: "",
    feedNum: 6,
    ...
    thumbWidth: 70,
    navText: "Leer &#9660;",
    frontText: "Subir &uArr;",
    noImage: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAIAAACQd1PeAAAAA3NCSVQICAjb4U/gAAAADElEQVQImWOor68HAAL+AX7vOF2TAAAAAElFTkSuQmCC",
    loading: "<span>Cargando...</span>",
    searching: "<span>Buscando...</span>",
    MonthNames: ["Ene", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dis"],
    noResult: "Oups!!! No hay Resultado"
};
...
function showLabels(c) {
    ...
    d += "<option value='' selected>CATEGORIA...</option>";
